...
- **AI Script Generation**: Analyzes Meta campaign performance data to generate optimized scripts following a structured three-part format (opening, product explanation, call-to-action) and specific word count constraints.
