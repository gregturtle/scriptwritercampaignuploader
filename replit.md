...
- August 13, 2025. Added dynamic voice selector with ElevenLabs API integration supporting Ella AI, Mark, and Samara X voices. Updated file naming to use human-readable timestamps (YYYY-MM-DD_HH-MM-SS) instead of Unix timestamps for better tracking and organization of both audio and video assets. Implemented timestamped folder organization - videos are now uploaded to Google Drive subfolders named "Generated_YYYY-MM-DD_HH-MM-SS" for easy batch management when uploading to Meta campaigns
