...
class MetaApiService {
  ...
  private async createPlaceholderThumbnail(videoName: string): Promise<string> {
    ...
    // Create a valid minimal JPEG file (1x1 pixel black image)
    // This is a complete, valid JPEG file structure that Meta will accept
    ...
    fs.writeFileSync(tempImagePath, validJpegBuffer);
    console.log(`Created valid placeholder thumbnail: ${tempImagePath}`);
