...
class AIScriptService {
  ...
  async generateScriptSuggestions(
    ...
    try {
      ...
      // Force 35-45 word scripts for maximum 12-13 seconds
      const targetWordCount = "35-45";
...
- MANDATORY: Each script must be EXACTLY 35-45 words (maximum 12-13 seconds when spoken)
...
- Must be EXACTLY 35-45 words (NEVER exceed 12-13 seconds when spoken naturally)
...
- CRITICAL: Count every word carefully - scripts over 45 words will be rejected
...
✓ Total script is no more than 45 words
