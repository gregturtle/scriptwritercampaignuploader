...
class AIScriptService {
  ...
  async generateScriptSuggestions(
    ...
    try {
      ...
      // Force 30-40 word scripts for maximum 11-12 seconds
      const targetWordCount = "30-40";
      console.log(`Targeting ${targetWordCount} words for maximum 11-12 second scripts`);
...
- MANDATORY: Each script must be EXACTLY 30-40 words (maximum 11-12 seconds when spoken)
...
- Must be EXACTLY 30-40 words (NEVER exceed 11-12 seconds when spoken naturally)
...
✓ The script would take no more than 11-12 seconds to say out loud at normal advertising pace
✓ what three words does not give directions, only provides precise locations that people navigate to
