...
class AIScriptService {
  ...
  async generateScriptSuggestions(
    ...
    try {
      ...
      // Force 60-70 word scripts for maximum 18-19 seconds
      const targetWordCount = "60-70";
      console.log(`Targeting ${targetWordCount} words for maximum 18-19 second scripts`);
...
- MANDATORY: Each script must be EXACTLY 60-70 words (maximum 18-19 seconds when spoken)
...
- Must be EXACTLY 60-70 words (NEVER exceed 18-19 seconds when spoken naturally)
